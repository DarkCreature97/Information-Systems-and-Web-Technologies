<html>
	...
	<body>
		...
		<h1>24 hours User locations </h1>
		
		<div class="formcontainer" align="Center">  
		<form id="entry" action="24hObtainData.php" method="get" name="submit" align="centre">
			<h4> Submit User details </h4>
			<input placeholder="Student ID" maxlength="9" name="studentID" size="30" type="text" tabindex="1" required autofocus/>
			</br>
			</br>
